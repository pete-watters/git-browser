    ...
    Ember.run.scheduleOnce('afterRender', this, function() {
      var Filter = (function() {
        ...
        Filter.enhance = function() {
          ...
          return Ember.$(Klass.selector).each(function() {
        ...
        Filter.prototype._buildUI = function() {
          this._summaryElement = Ember.$('<label></label>').
          addClass('summary').
          attr('data-role', 'summary').
          prependTo(this._optionsContainer);

          this._clearSelectionButton = Ember.$('<button class=clear></button>').
          text('Clear').
          attr('type', 'button').
        ...
        Filter.prototype._bindEvents = function() {
          ...
          Ember.$('body').click(function(e) {
            var inFilter = Ember.$(e.target).closest(self.constructor.selector).length > 0;
        ...
        Filter.prototype._labelsFor = function(inputs) {
          return inputs.map(function() {
            ...
            return Ember.$("label[for='" + id + "']").text();
          }).get();
        };

        Filter.prototype._allOptionsContainers = function() {
          return Ember.$(this.constructor.selector + " " + this.constructor.optionsContainerSelector);
        };
